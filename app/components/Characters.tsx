  ...
  const characters: Character[] = [
    {
      ...
      stats: { ninjutsu: 80, taijutsu: 85, genjutsu: 20, intelligence: 60, strength: 90, speed: 85 },
      backstory: "Ostracized by his village for having the Nine-Tailed Fox sealed within him, Naruto worked relentlessly to gain their respect, eventually becoming a hero and achieving his dream of becoming the Seventh Hokage.",
    },
    {
      id: 2,
      name: "Sasuke Uchiha",
      ...
      affiliation: "Konohagakure",
      stats: { ninjutsu: 95, taijutsu: 85, genjutsu: 90, intelligence: 85, strength: 80, speed: 90 },
      backstory: "The last survivor of the Uchiha clan massacre, Sasuke dedicated his life to avenging his family by killing his older brother, Itachi. After learning the truth, his goals shifted, leading him on a path of redemption alongside Naruto.",
    },
    {
      id: 3,
      name: "Sakura Haruno",
      ...
      affiliation: "Konohagakure",
      stats: { ninjutsu: 75, taijutsu: 90, genjutsu: 70, intelligence: 95, strength: 95, speed: 75 },
      backstory: "Starting as a kunoichi lacking in combat prowess compared to her teammates Naruto and Sasuke, Sakura trained rigorously under the Fifth Hokage, Tsunade, to become a master of medical ninjutsu and chakra-enhanced strength.",
    },
    {
      id: 4,
      name: "Kakashi Hatake",
      ...
      affiliation: "Konohagakure",
      stats: { ninjutsu: 95, taijutsu: 85, genjutsu: 80, intelligence: 95, strength: 75, speed: 85 },
      backstory: "Known worldwide as the Copy Ninja, Kakashi received a Sharingan from his dying friend Obito Uchiha. Despite a tragic past involving the loss of his team and mentor, he became an exceptional leader, guiding Team 7 and eventually serving as the Sixth Hokage.",
    },
    {
      id: 5,
      name: "Itachi Uchiha",
      ...
      stats: { ninjutsu: 95, taijutsu: 85, genjutsu: 100, intelligence: 95, strength: 70, speed: 95 },
      backstory: "A true pacifist forced into an impossible corner, Itachi massacred his own clan to prevent a civil war that would have devastated the Hidden Leaf. He lived as a vilified rogue ninja to protect his younger brother, Sasuke, and his village.",
    },
    {
      id: 6,
      name: "Namikage Mina",
      ...
      affiliation: "Konohagakure",
      stats: { ninjutsu: 95, taijutsu: 85, genjutsu: 60, intelligence: 95, strength: 75, speed: 100 },
      backstory: "Renowned as the Yellow Flash of the Leaf for his unparalleled speed using the Flying Thunder God technique, Minato sacrificed his life to seal the Nine-Tailed Fox into his newborn son, Naruto, saving the village from destruction.",
    },
    {
      id: 7,
      name: "Jiraiya",
      ...
      affiliation: "Konohagakure",
      stats: { ninjutsu: 95, taijutsu: 85, genjutsu: 60, intelligence: 85, strength: 80, speed: 85 },
      backstory: "One of the Legendary Sannin, Jiraiya traveled the world seeking knowledge and writing novels. He trained several great shinobi, including Minato and Naruto, acting as a profound mentor and father figure to Naruto.",
    },
    {
      id: 8,
      name: "Madara Uchiha",
      ...
      affiliation: "Akatsuki",
      stats: { ninjutsu: 100, taijutsu: 100, genjutsu: 100, intelligence: 95, strength: 95, speed: 95 },
      backstory: "Co-founder of the Hidden Leaf Village alongside his rival Hashirama Senju, Madara was consumed by the Curse of Hatred. He orchestrated events from the shadows for decades to impose his vision of forced peace upon the world.",
    },
    {
      id: 9,
      name: "Obito Uchiha",
      ...
      affiliation: "Akatsuki",
      stats: { ninjutsu: 90, taijutsu: 80, genjutsu: 85, intelligence: 85, strength: 80, speed: 90 },
      backstory: "Believed dead after being crushed by a boulder, Obito was saved by Madara Uchiha. The traumatic loss of his teammate Rin shattered his idealism, turning him into a pawn who manipulated the Akatsuki and started the Fourth Great Ninja War.",
    },
    {
      id: 10,
      name: "Shikamaru Nara",
      ...
      affiliation: "Konohagakure",
      stats: { ninjutsu: 75, taijutsu: 50, genjutsu: 50, intelligence: 100, strength: 50, speed: 60 },
      backstory: "Initially appearing lazy, Shikamaru is a tactical genius capable of thinking ten steps ahead. He grew from a reluctant shinobi into a highly dependable leader, eventually becoming the chief advisor to the Seventh Hokage.",
    },
  ];
