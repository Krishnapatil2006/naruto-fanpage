          ...
          <div className="p-8 overflow-y-auto max-h-[600px] custom-scrollbar">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-3 bg-orange-500/10 rounded-lg border border-orange-500/30">
                  ...
                  <div className="flex flex-col">
                    <span className="text-gray-400 text-sm">Clan</span>
              ...
              <button
                ...
                className="w-full px-6 py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-xl font-bold text-lg hover:scale-105 transition-all duration-300 shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50"
              >
              ...
              {showFullProfile && (
                <div className="mt-8 pt-8 border-t border-orange-500/30 animate-fade-in-up space-y-8">
                  {/* Stats */}
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {[
                        { label: "Ninjutsu", value: character.stats.ninjutsu, color: "from-blue-400 to-blue-600" },
                        { label: "Taijutsu", value: character.stats.taijutsu, color: "from-green-400 to-green-600" },
                        { label: "Genjutsu", value: character.stats.genjutsu, color: "from-purple-400 to-purple-600" },
                        { label: "Intelligence", value: character.stats.intelligence, color: "from-yellow-400 to-yellow-600" },
                        { label: "Strength", value: character.stats.strength, color: "from-red-400 to-red-600" },
                        { label: "Speed", value: character.stats.speed, color: "from-orange-400 to-orange-600" },
                      ].map((stat, i) => (
                        <div key={i} className="space-y-2">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-300 font-medium">{stat.label}</span>
                            <span className="text-orange-400 font-bold">{stat.value}/100</span>
                          </div>
