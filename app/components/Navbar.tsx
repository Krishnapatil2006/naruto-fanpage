    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-0">
            ...
            {/* Watch Now Button */}
            <a href="https://t.me/narutoepisodes120" target="_blank" rel="noopener noreferrer" className="relative ml-4 px-6 py-2.5 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-full overflow-hidden group font-semibold shadow-lg shadow-orange-500/30 hover:shadow-orange-500/60 transition-shadow duration-300">
              {/* Shimmer effect */}
      ...
      >
        <div className="px-4 pt-2 pb-6 space-y-2 bg-black/95 backdrop-blur-md border-t border-orange-500/20">
          ...
          <a href="https://t.me/narutoepisodes120" target="_blank" rel="noopener noreferrer" className="block text-center w-full px-6 py-3 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-full mt-4 font-semibold relative overflow-hidden group shadow-lg shadow-orange-500/30">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
